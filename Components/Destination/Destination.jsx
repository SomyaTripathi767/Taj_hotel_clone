...
const Destination = () => {
  ...
  return (
    <div id="destination">
      ...
      <div className="Destination-backgaroud-imge">
        <div className="title-Destination">
          <h1 className="main-hotel-title">Our Destinations</h1>
        </div>
      ...
      <div className="EXPLORE-TAj" id="Destination-TAj">
        <h2>World Awaits</h2>
      ...
      <div className="hotel-Explore-Slider" id="Destination-slider">
        <SliderComponent />
      </div>

      <div className="Room-section" id="destionation-room-sec">
        <RoomSection />
      </div>

      <div className="footer" id="destination-Footer">
        <Footer />
      </div>
    </div>
  );
